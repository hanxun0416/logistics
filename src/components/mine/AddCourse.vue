        ...
        <van-tab title="城市">
            <div class="card" >
                <div class="pro-list "
                 ...
                 <van-button type="info" class="addmain-footer-btn" @click="addCourse">确定</van-button>
            </div>
                </van-tab>
        </van-tabs>
        </div>
...
this.current1=index
    ...
    addCourse(){
      ...
      this.current1=200,
       this.active=0
       this.startAdd = this.area+this.city
       this.$emit("startAdd",this.startAdd)
      //  this.$router.push({path:'/addendcourse',query:{startAdd:startAdd},replace: true})
    }
},
}
</script>
